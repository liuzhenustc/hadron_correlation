...
public:
  ...
  /// returns pointer to current StPicoEventPlane (class holding the event plane information)
  static StPicoEventPlane* eventPlane() { return (StPicoEventPlane*)picoArrays[picoEventPlane]->UncheckedAt(0); }
